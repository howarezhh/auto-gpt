...
DEFAULT_DB_POOL_SIZE="${DEFAULT_DB_POOL_SIZE:-8}"
DEFAULT_DB_MAX_OVERFLOW="${DEFAULT_DB_MAX_OVERFLOW:-4}"
DEFAULT_DB_POOL_TIMEOUT="${DEFAULT_DB_POOL_TIMEOUT:-5}"
DEFAULT_DB_POOL_RECYCLE="${DEFAULT_DB_POOL_RECYCLE:-1800}"
DEFAULT_ENABLE_BACKGROUND_WORKERS="${DEFAULT_ENABLE_BACKGROUND_WORKERS:-true}"
...
DEFAULT_GLOBAL_MAX_ACTIVE_REQUESTS="${DEFAULT_GLOBAL_MAX_ACTIVE_REQUESTS:-1000}"
DEFAULT_GLOBAL_MAX_ACTIVE_STREAMS="${DEFAULT_GLOBAL_MAX_ACTIVE_STREAMS:-1000}"
DEFAULT_API_KEY_MAX_ACTIVE_REQUESTS="${DEFAULT_API_KEY_MAX_ACTIVE_REQUESTS:-1000}"
DEFAULT_API_KEY_MAX_ACTIVE_STREAMS="${DEFAULT_API_KEY_MAX_ACTIVE_STREAMS:-1000}"
DEFAULT_ACCOUNT_MAX_ACTIVE_REQUESTS="${DEFAULT_ACCOUNT_MAX_ACTIVE_REQUESTS:-1000}"
DEFAULT_ACCOUNT_MAX_ACTIVE_STREAMS="${DEFAULT_ACCOUNT_MAX_ACTIVE_STREAMS:-1000}"
DEFAULT_PROVIDER_MAX_ACTIVE_REQUESTS="${DEFAULT_PROVIDER_MAX_ACTIVE_REQUESTS:-1000}"
DEFAULT_PROVIDER_MAX_ACTIVE_STREAMS="${DEFAULT_PROVIDER_MAX_ACTIVE_STREAMS:-1000}"
...
DEFAULT_UPSTREAM_MAX_CONNECTIONS="${DEFAULT_UPSTREAM_MAX_CONNECTIONS:-1200}"
DEFAULT_UPSTREAM_MAX_KEEPALIVE_CONNECTIONS="${DEFAULT_UPSTREAM_MAX_KEEPALIVE_CONNECTIONS:-300}"
