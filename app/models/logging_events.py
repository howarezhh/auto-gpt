...
class RequestRouteDecisionEvent(Base):
    ...
    hard_filter_final_candidate_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    candidate_count_after_failed_exclusion: Mapped[int | None] = mapped_column(Integer, nullable=True)
    base_candidate_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    candidate_expand_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    candidate_window_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    failed_candidate_keys_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    failed_candidate_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    hard_filter_reason_counts_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    stage_traces_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    retry_wait_ms: Mapped[int | None] = mapped_column(Integer, nullable=True)
    retry_wait_plan_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    selection_guard: Mapped[str | None] = mapped_column(Text, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=now_beijing, index=True)
...
class RequestProviderAttemptEvent(Base):
    ...
    route_round: Mapped[int | None] = mapped_column(Integer, nullable=True)
    retry_index: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    retry_wait_seconds: Mapped[float | None] = mapped_column(Float, nullable=True)
    retry_wait_plan_json: Mapped[str | None] = mapped_column(Text, nullable=True)
