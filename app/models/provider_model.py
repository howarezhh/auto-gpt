...
class ProviderModel(Base):
    ...
    upstream_model_name: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    source_currency: Mapped[str] = mapped_column(Text, nullable=False, default="USD")
    billing_currency: Mapped[str] = mapped_column(Text, nullable=False, default="USD")
    source_input_price_per_1k: Mapped[Decimal | None] = mapped_column(Numeric(DB_PRICE_PRECISION, DB_PRICE_SCALE), nullable=True)
    source_output_price_per_1k: Mapped[Decimal | None] = mapped_column(Numeric(DB_PRICE_PRECISION, DB_PRICE_SCALE), nullable=True)
    source_cache_price_per_1k: Mapped[Decimal | None] = mapped_column(Numeric(DB_PRICE_PRECISION, DB_PRICE_SCALE), nullable=True)
    source_cache_write_price_per_1k: Mapped[Decimal | None] = mapped_column(Numeric(DB_PRICE_PRECISION, DB_PRICE_SCALE), nullable=True)
    ...
    rounding_strategy: Mapped[str] = mapped_column(Text, nullable=False, default="ROUND_HALF_UP")
