...
class Provider(Base):
    ...
    trust_level: Mapped[str] = mapped_column(Text, nullable=False, default="standard")
    content_integrity_status: Mapped[str] = mapped_column(Text, nullable=False, default="unknown")
    content_integrity_score: Mapped[int] = mapped_column(Integer, nullable=False, default=80)
