...
class Provider(Base):
    ...
    max_active_requests: Mapped[int | None] = mapped_column(Integer, nullable=True, default=1000)
    max_active_streams: Mapped[int | None] = mapped_column(Integer, nullable=True, default=1000)
