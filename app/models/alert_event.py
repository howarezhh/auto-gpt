...
class AlertEvent(Base):
    ...
    first_seen_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=now_beijing)
    last_seen_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, default=now_beijing)
