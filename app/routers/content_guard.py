        ...
        "events": [
            {
                ...
                "diagnostics_json": event.diagnostics_json,
                ...
                "provider_model_id": event.provider_model_id if event.provider_model_id is not None else (request_log.resolved_provider_model_id if request_log else None),
                ...
                "is_stream": event.is_stream if event.is_stream is not None else (request_log.is_stream if request_log else None),
                ...
                "request_log": {
                    ...
                    "ttfb_ms": request_log.ttfb_ms,
                    "error_code": request_log.error_code,
                    "message": request_log.message,
                    "content_guard_result": request_log.content_guard_result,
                    "content_guard_risk_level": request_log.content_guard_risk_level,
                    "content_guard_action": request_log.content_guard_action,
                    "content_guard_final_strategy": request_log.content_guard_final_strategy,
