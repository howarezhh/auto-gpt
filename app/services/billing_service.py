...
class BillingService:
    ...
    def sync_request_billing(db: Session, log: RequestLog) -> None:
        ...
        if delta:
            ...
            if api_key.balance_amount is not None:
        ...
        if new_amount > 0:
            ...
            existing_record.balance_after = (
                BillingService.to_decimal(api_key.balance_amount) if api_key.balance_amount is not None else None
            )
