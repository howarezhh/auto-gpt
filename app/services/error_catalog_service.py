...
class ErrorCatalogService:
    ...
    CATEGORY_HANDLING_STRATEGIES: dict[str, str] = {
        ...
        "model_unavailable": "核对模型名称、模型启用状态、API Key 授权、模型映射、挂载提供商和健康检查结果。",
        ...
        "upstream_transient": "核对上游状态码、请求 ID、候选重试 trace、网络与提供商健康；保留截断摘要，避免暴露原始敏感响应。",
...
ErrorCatalogService.SPECS.update(
    {
        ...
        "model_not_available": _spec(
            ...
            False,
            False,
            "检查模型是否启用、是否有健康提供商挂载，以及当前 API Key 是否有权限。",
        ),
        ...
        "chat_completion_provider_not_available": _spec(
            ...
            True,
            True,
            "检查支持 Chat Completions 管理接口的提供商健康与授权状态。",
        ),
        ...
        "moderation_provider_not_available": _spec(
            ...
            True,
            True,
            "检查支持 Moderation 的提供商健康、模型挂载和授权状态。",
        ),
