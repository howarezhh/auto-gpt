...
19. `base.html` 与 `auth_base.html` 静态资源版本已同步到 `app.css?v=20260608-06` 与 `app.js?v=20260608-31`，壳层移除了顶部上下文标题块。前端重构时应保持资源版本与 shell 导航职责独立，不再让页面切换逻辑依赖 `#topbar-title` 这类易漂移 DOM。
