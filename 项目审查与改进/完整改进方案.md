...
19. `base.html` 与 `auth_base.html` 静态资源版本参数必须随 `app/static/` 可执行资源变化同步更新；当前最新版本为 `app.css?v=20260608-08`、`app.js?v=20260608-38`。
...
- `base.html` 与 `auth_base.html` 静态资源版本参数已同步更新到 `app.css?v=20260608-08`、`app.js?v=20260608-38`。
